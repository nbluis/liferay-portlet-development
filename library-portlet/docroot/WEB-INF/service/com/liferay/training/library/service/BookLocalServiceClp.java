...
public class BookLocalServiceClp implements BookLocalService {
	public BookLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
		...
		_deleteBookMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteBook", com.liferay.training.library.model.Book.class);
		...
		_getBookMethodKey8 = new MethodKey(_classLoaderProxy.getClassName(),
				"getBook", long.class);

		_getBooksMethodKey9 = new MethodKey(_classLoaderProxy.getClassName(),
				"getBooks", int.class, int.class);

		_getBooksCountMethodKey10 = new MethodKey(_classLoaderProxy.getClassName(),
				"getBooksCount");

		_updateBookMethodKey11 = new MethodKey(_classLoaderProxy.getClassName(),
	...
	public com.liferay.training.library.model.Book getBook(long bookId)
		...
		MethodHandler methodHandler = new MethodHandler(_getBookMethodKey8,
				bookId);
	...
	public java.util.List<com.liferay.training.library.model.Book> getBooks(
		...
		MethodHandler methodHandler = new MethodHandler(_getBooksMethodKey9,
				start, end);
	...
	public int getBooksCount()
		...
		MethodHandler methodHandler = new MethodHandler(_getBooksCountMethodKey10);
	...
	public com.liferay.training.library.model.Book updateBook(
		...
		MethodHandler methodHandler = new MethodHandler(_updateBookMethodKey11,
				ClpSerializer.translateInput(book));
	...
	public com.liferay.training.library.model.Book updateBook(
		...
		MethodHandler methodHandler = new MethodHandler(_updateBookMethodKey12,
	...
	private MethodKey _getBookMethodKey8;
	private MethodKey _getBooksMethodKey9;

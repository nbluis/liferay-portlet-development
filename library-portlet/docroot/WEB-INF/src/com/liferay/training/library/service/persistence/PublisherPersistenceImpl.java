...
import com.liferay.training.library.NoSuchPublisherException;
import com.liferay.training.library.model.Publisher;
import com.liferay.training.library.model.impl.PublisherImpl;
import com.liferay.training.library.model.impl.PublisherModelImpl;
...
public class PublisherPersistenceImpl extends BasePersistenceImpl<Publisher>
	...
	public static final String FINDER_CLASS_NAME_LIST = FINDER_CLASS_NAME_ENTITY +
		".List";
	public static final FinderPath FINDER_PATH_FIND_BY_GROUPID = new FinderPath(PublisherModelImpl.ENTITY_CACHE_ENABLED,
			PublisherModelImpl.FINDER_CACHE_ENABLED, FINDER_CLASS_NAME_LIST,
			"findByGroupId",
			new String[] {
				Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUPID = new FinderPath(PublisherModelImpl.ENTITY_CACHE_ENABLED,
			PublisherModelImpl.FINDER_CACHE_ENABLED, FINDER_CLASS_NAME_LIST,
			"countByGroupId", new String[] { Long.class.getName() });
	public static final FinderPath FINDER_PATH_FIND_ALL = new FinderPath(PublisherModelImpl.ENTITY_CACHE_ENABLED,
			PublisherModelImpl.FINDER_CACHE_ENABLED, FINDER_CLASS_NAME_LIST,
	...
	public void cacheResult(List<Publisher> publishers) {
		for (Publisher publisher : publishers) {
			if (EntityCacheUtil.getResult(
						...
						PublisherImpl.class, publisher.getPrimaryKey(), this) == null) {
	 ...
	 *
	 * @param primaryKey the primary key of the publisher to remove
	 * @return the publisher that was removed
	 * @throws com.liferay.portal.NoSuchModelException if a publisher with the primary key could not be found
	...
	public Publisher remove(long publisherId)
		...
		try {
			...
			Publisher publisher = (Publisher)session.get(PublisherImpl.class,
					new Long(publisherId));

			if (publisher == null) {
				if (_log.isWarnEnabled()) {
					_log.warn(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + publisherId);
				}
	...
	protected Publisher removeImpl(Publisher publisher)
		...
		try {
			...
			BatchSessionUtil.delete(session, publisher);
		}
		catch (Exception e) {
			throw processException(e);
		}
	...
	public Publisher updateImpl(
		...
		try {
			...
			BatchSessionUtil.update(session, publisher, merge);
	...
	protected Publisher toUnwrappedModel(Publisher publisher) {
		...
		publisherImpl.setCompanyId(publisher.getCompanyId());
		publisherImpl.setGroupId(publisher.getGroupId());
		publisherImpl.setName(publisher.getName());
		publisherImpl.setEmailAddress(publisher.getEmailAddress());
		publisherImpl.setWebsite(publisher.getWebsite());
		publisherImpl.setPhoneNumber(publisher.getPhoneNumber());

		return publisherImpl;
	}

	/**
	 * Finds the publisher with the primary key or throws a {@link com.liferay.portal.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the publisher to find
	...
	public Publisher findByPrimaryKey(long publisherId)
		throws NoSuchPublisherException, SystemException {
		Publisher publisher = fetchByPrimaryKey(publisherId);
	...
	public Publisher fetchByPrimaryKey(long publisherId)
		...
		Publisher publisher = (Publisher)EntityCacheUtil.getResult(PublisherModelImpl.ENTITY_CACHE_ENABLED,
				PublisherImpl.class, publisherId, this);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Publisher> findByGroupId(long groupId)
		throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Publisher> findByGroupId(long groupId, int start, int end)
		throws SystemException {
	...
	public List<Publisher> findByGroupId(long groupId, int start, int end,
		...
		List<Publisher> list = (List<Publisher>)FinderCacheUtil.getResult(FINDER_PATH_FIND_BY_GROUPID,
				finderArgs, this);
		...
		if (list == null) {
			...
			query.append(_SQL_SELECT_PUBLISHER_WHERE);
			...
			try {
				...
				list = (List<Publisher>)QueryUtil.list(q, getDialect(), start,
						end);
			}
			catch (Exception e) {
				throw processException(e);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Publisher findByGroupId_First(long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchPublisherException, SystemException {
		List<Publisher> list = findByGroupId(groupId, 0, 1, orderByComparator);
		...
		if (list.isEmpty()) {
			...
			throw new NoSuchPublisherException(msg.toString());
		}
		else {
			return list.get(0);
		}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Publisher findByGroupId_Last(long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchPublisherException, SystemException {
		int count = countByGroupId(groupId);

		List<Publisher> list = findByGroupId(groupId, count - 1, count,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Publisher[] findByGroupId_PrevAndNext(long publisherId,
		...
		try {
			...
			array[0] = getByGroupId_PrevAndNext(session, publisher, groupId,
					orderByComparator, true);

			array[1] = publisher;

			array[2] = getByGroupId_PrevAndNext(session, publisher, groupId,
	...
	protected Publisher getByGroupId_PrevAndNext(Session session,
		Publisher publisher, long groupId, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
		...
		if (orderByComparator != null) {
			Object[] values = orderByComparator.getOrderByValues(publisher);
	...
	public List<Publisher> findAll(int start, int end,
		...
		List<Publisher> list = (List<Publisher>)FinderCacheUtil.getResult(FINDER_PATH_FIND_ALL,
				finderArgs, this);
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sql = _SQL_SELECT_PUBLISHER.concat(PublisherModelImpl.ORDER_BY_JPQL);
			}
	...
	public void removeByGroupId(long groupId) throws SystemException {
		for (Publisher publisher : findByGroupId(groupId)) {
			remove(publisher);
		}
	}
	...
	public int countByGroupId(long groupId) throws SystemException {
		...
		if (count == null) {
			...
			query.append(_SQL_COUNT_PUBLISHER_WHERE);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.liferay.training.library.model.Publisher")));
	...
	private static final String _SQL_SELECT_PUBLISHER_WHERE = "SELECT publisher FROM Publisher publisher WHERE ";
